...
```{r}
system.time(gapminderlarger <- read.csv("gapminder-larger.csv", header=T))
```
...
## New and Shiny: FEATHER - A Fast On-Disk Format for Data Frames for R and Python, powered by Apache Arrow
...
system.time(gapminderlarger <- read_feather(path))
```
